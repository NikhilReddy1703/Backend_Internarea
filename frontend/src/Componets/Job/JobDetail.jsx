...
useEffect(()=>{
  ...
  const response=await axios.get(`https://backend-internarea.vercel.app/api/job/${id}`)
...
const text=document.getElementById("text")
  if (text.value==="") {
    ...
    await axios.post("https://backend-internarea.vercel.app/api/application",bodyJson).then((res)=>{
